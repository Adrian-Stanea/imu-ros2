/*******************************************************************************
 *   @file   adis1647x_handler.h
 *   @brief  Device handler for ADIS1647x family devices
 ********************************************************************************/

#ifndef ADIS1647X_HANDLER_H
#define ADIS1647X_HANDLER_H
...
/**
 * @brief Device handler for ADIS1647x family IMU devices
 * - ADIS16477-1, ADIS16477-2, ADIS16477-3
 */
class ADIS1647xHandler : public BaseDeviceHandler {
public:
    explicit ADIS1647xHandler(std::shared_ptr<DeviceConfig> config);
    ~ADIS1647xHandler() override = default;
